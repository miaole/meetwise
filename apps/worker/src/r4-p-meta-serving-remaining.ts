 ...
 * (routedServing/facets/deploy false). This knife deepens serving-surface
 * honesty only — it does NOT close FUNNEL-01 / R4 / 题域已隔离.
 *
 * HARD:
 *   - Ban forging MetadataReviewReceipt serving / claiming FUNNEL-01 closed.
 *   - 01A source seal ≠ 01 closed.
...
export type PMetaServingRemainingStatus = {
  ...
  /** MS1: independent receipt enters routed serving consumer — still open. */
  ...
  /** Facets actually served on MetadataReviewReceipt routed path — empty while open. */
 ...
 * Aligns with F2 classifyPMetaRemaining three false bits; adds facet inventory
 * + local-01A-vs-standard-deploy honesty.
 */
...
/** FUNNEL-01 closed iff MS1+MS2+MS3 wired. 01A alone ≠ 01. */
