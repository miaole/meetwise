...
const approval = { schemaVersion: 1, generation: 1, mode: 'public-full-stack', releaseDigest: 'abcdef0', commit: 'a'.repeat(40), tree: 'b'.repeat(40), webBuildSha256: '4'.repeat(64), staticAssetsSha256: '5'.repeat(64), origin: 'https://preview.tail39416d.ts.net', releasePath: target.releasePath, releaseTreeDigest: target.releaseTreeDigest, apiContractDigest: target.apiContractDigest, targetDigest };
