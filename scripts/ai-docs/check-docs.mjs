...
const requiredTerms = new Map([
  ...
  ["ai-docs/skills/testing/SKILL.md", ["pnpm regression", "releaseEvidence", "出处", "--core", "--live", "always-on", "review/verify", "automation does not trust AI outputs", "multi-round allowed"]],
  ["ai-docs/skills/testing/post-change-review.md", ["review/verify", "automation does not trust AI outputs", "multi-round allowed"]],
