...
const requiredTerms = new Map([
  ...
  ["AGENTS.md", ["文档先行", "契约先行", "测试先行", "skills/testing/sop.md"]],
  ["CLAUDE.md", ["skills/testing/sop.md"]],
  ["ai-docs/meta/task-sop.md", ["skills/testing/sop.md"]],
  ["ai-docs/product/vision.md", ["面试", "职业路径"]],
  ["ai-docs/architecture/system-blueprint.md", ["Next.js", "NestJS", "LangGraph", "Postgres"]],
  ["ai-docs/architecture/current-runtime-truth.md", ["已验证", "发布阻断", "LangGraph", "RAG", "Langfuse", "issued_turns", "overview.answered", "SCOR-00H", "软预算", "boundedAbsoluteMaxTurns", "仅面试练习", "preview-controlled-write", "POST /interview/:id/answers", "generation_unavailable", "interview-dispatch:prove", "interview-dispatch:gate:prove", "interview-dispatch-receipts"]],
  ...
  ["ai-docs/meta/index.md", ["skills/testing/sop.md", "skills/testing/SKILL.md", "skills/README.md"]],
  ["ai-docs/skills/testing/SKILL.md", ["pnpm regression", "releaseEvidence", "出处", "status: draft"]],
  ["ai-docs/skills/testing/sop.md", ["审核", "回归", "status: draft", "releaseEvidence", "always-on", "不减免", "生成物默认不可信", "不得声称完成"]],
  ["ai-docs/skills/testing/post-change-review.md", ["pnpm regression", "未查", "生成物默认不可信", "skip-as-pass", "不得标 READY"]],
