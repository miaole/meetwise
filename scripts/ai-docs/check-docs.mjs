...
const requiredTerms = new Map([
  ...
  ["ai-docs/delivery/e2e-platform-integration.md", ["#55", "#64", "#69", "#71", "#70", "#66", "#73", "#74", "feature/e2e-platform-integration", "fail-closed", "releaseEvidence", "supersede"]],
