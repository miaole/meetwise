...
const requiredTerms = new Map([
  ...
  ["ai-docs/architecture/current-runtime-truth.md", ["已验证", "发布阻断", "LangGraph", "RAG", "Langfuse", "issued_turns", "overview.answered", "interview_erasure_authorization_not_available", "/answers", "RAG-FUNNEL-01A", "0124_rag_retrieval_acl_fail_closed", "0125_memory_vector_chunk_erasure", "绝对杀开关默认 120", "软预算", "boundedAbsoluteMaxTurns", "INT-LONG-INTERVIEW-01", "SCOR-00H", "0126", "答题双写互斥", "0127", "OCR_PREVIEW", "resume.ocr.v1", "WORKER-DISPATCH-002", "0128", "0128_interview_dispatch_fairness", "interview-dispatch:unit:prove", "0129", "预览版", "erasure-preview", "0130", "observeInterviewSignals", "early_weak", "thrashing", "SIGNAL-01", "createInterviewVoiceSeams", "voice.asr.v1", "/speak/stream"]],
  ...
  ["ai-docs/delivery/e2e-platform-integration.md", ["#55", "#64", "#69", "#71", "#70", "#66", "#73", "#74", "#75", "#77", "#82", "#72", "#79", "feature/e2e-platform-integration", "fail-closed", "releaseEvidence", "supersede"]],
