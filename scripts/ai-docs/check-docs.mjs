...
const requiredTerms = new Map([
  ...
  ["ai-docs/testing/strategy/test-strategy.md", ["contract", "E2E", "golden", "e2e:isolated", "Playwright", "主层", "次层", "不得默认信任", "多轮门禁", "e2e-platform"]],
  ...
  ["ai-docs/skills/testing/SKILL.md", ["pnpm regression", "releaseEvidence", "出处", "status: draft", "fail-closed", "生成物默认不可信", "skip-as-pass", "--core", "--live", "always-on", "review/verify", "automation does not trust AI outputs", "multi-round allowed", "e2e-platform"]],
