...
const requiredTerms = new Map([
  ...
  ["AGENTS.md", ["文档先行", "契约先行", "测试先行", "不得默认信任", "多轮门禁"]],
  ...
  ["ai-docs/rules/global/ai-generated-review.md", ["不得默认信任", "审核", "验证", "多轮门禁", "自动化"]],
  ["ai-docs/testing/conventions/test-authoring.md", ["e2e:isolated", "Playwright", "fetch", "skills/testing", "禁止伪验收"]],
  ["ai-docs/meta/index.md", ["test-authoring", "skills/testing", "e2e:isolated", "ai-generated-review"]],
  ["ai-docs/skills/testing/SKILL.md", ["pnpm regression", "releaseEvidence", "出处", "不得默认信任"]],
