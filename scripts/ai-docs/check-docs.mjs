...
const requiredTerms = new Map([
  ...
  ["ai-docs/testing/strategy/test-strategy.md", ["contract", "E2E", "golden", "e2e:isolated", "Playwright", "主层", "次层"]],
  ["ai-docs/testing/conventions/test-authoring.md", ["e2e:isolated", "Playwright", "fetch", "skills/testing", "禁止伪验收"]],
  ["ai-docs/meta/index.md", ["test-authoring", "skills/testing", "e2e:isolated"]],
