...
export const OPTIONAL_ALWAYS_ON = Object.freeze([
  ...
  'last-event-id:unit:prove',
  'privacy-erasure-preview:domain:prove',
  'privacy-erasure-preview:contract:prove',
  'adaptive-signals:prove',
  'adaptive-signals-graph:prove',
  'signal-sse:prove',
  'signal-sse-contract:prove',
