...
- SQL 侧枚举：最新迁移对 `privacy_deletion_target.sink` 的 CHECK（当前为 `0125_memory_vector_chunk_erasure.sql`）。`0124_rag_retrieval_acl_fail_closed.sql` 已在 main（#71 / `e202739`）。本 PR 只新增 0125，不改 0124。
