...
| **W1b** | PG redundant retire/trace batches · **ZERO DROP** · docs/trace only | **`executed:awaiting_post_prove_dual`** · Batch A+B executed · Dual PASS on W1 ≠ auto-auth coding · **no delete batch** · ≠DROP · Ban self-write post_prove_dual_pass | `harness/w1b-pg-redundant-retire-batches.md` |
