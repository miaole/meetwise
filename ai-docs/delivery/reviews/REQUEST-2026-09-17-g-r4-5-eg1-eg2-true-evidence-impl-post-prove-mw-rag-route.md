# REQUEST — **G-R4-5 EG1+EG2 true-evidence / impl** **post-prove** → mw-rag-route
...
**Pair**: `REQUEST-2026-09-17-g-r4-5-eg1-eg2-true-evidence-impl-post-prove-mw-e2e-ha.md`  
...
| `receipts/2026-09-17-g-r4-5-eg1-dual-claim-evidence.json` | EG1 dual-claim evidence · 01A≡01 |
| `rag-funnel-01-08-covered-matrix.md` + EG2 json | EG2 covered matrix · Ban invent covered |
| `execution-master-checklist.md` RAG-FUNNEL-* | checklist 01…08 still `[ ]` · SSOT NOT flipped |
| `harness/g-r4-5-eg1-eg6-residual-true-evidence.md` | Residual prior · ≠ this · retained OPEN |
| `harness/g-r4-5-evidence-close.md` | Evidence-close prior · ≠ this · retained OPEN |
...
2. EG1 MetadataReviewReceipt / RAG-FUNNEL-01 dual-claim evidence emitted (MS1+MS2+MS3 anchors · Ban forge) · EG2 FUNNEL-01…08 honest matrix emitted (01A source_sealed · 01 product_surfaces_true · 02A…08 not_covered · coveredCount=0 · Ban invent covered).  
3. EXIT **2×0** ≠ EG1/EG2 closed ≠ dual-claim closed ≠ 题域已隔离 ≠ R4/FUNNEL product closed.  
4. **Ban idle re-run of the same 5×meta prove as fake close**.  
...
1. 请抽查 EG1 dual-claim json（`gap01AEquals01=true` · `gR45DualClaimClosed=false`）+ EG2 matrix（coveredCount=0 · Ban invent covered）；复跑至少两 CMD，附 EXIT。  
2. 是否同意 **≠ residual honesty wash** `e23c5fd`/`04c6ed1` · **≠ evidence-close wash** `b4a8ede`/`ae99258` · **Ban idle re-run of same 5×meta as fake close**？  
3. **G-R4-5 STILL OPEN** / **题域 STILL OPEN** / **R4/FUNNEL product STILL OPEN** / **MS3 ≠ R4 closed** / EG1 STILL OPEN / EG2 STILL OPEN / EG3–EG6 deferred / checklist SSOT NOT flipped 是否仍硬钉？  
4. 是否同意 status 保持 **`executed:awaiting_post_prove_dual`**（实现方未自写 `post_prove_dual_pass`）· EXIT=0 ≠ EG1/EG2 / dual-claim / 题域 / R4 已关？  
...
Please write the conclusion to `reviews/`（e.g. `2026-09-17-g-r4-5-eg1-eg2-true-evidence-impl-post-prove-mw-rag-route.md`）. **Ban** implementer writing pass.
...
*REQUEST · mw-rag-route · G-R4-5 EG1+EG2 true-evidence post-prove · 2026-09-17 (~21:24 PT) · prove EXIT 2×0 · releaseEvidence=false · ≠HA · ≠suite · EG1/EG2 STILL OPEN · G-R4-5 STILL OPEN · 题域 STILL OPEN · R4/FUNNEL product STILL OPEN · MS3 ≠ R4 closed · SSOT NOT flipped · awaiting dual*
