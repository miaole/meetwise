...
> **2026-09-17 (~19:29 PT) · R2 real close / SSOT flip REQUEST (additive · ≠ W4)**  
...
- **R2-SSOT** (additive · ≠ W4): `harness/r2-ssot-flip-real-close.md` · **`REQUEST-ready / not_run:pre_dual`** · R2 NOT closed until prove+authorize · Dual PASS ≠ authorize coding · Ban false green · no SSOT flip yet · `releaseEvidence=false` · ≠HA
