...
> **2026-09-17 (~01:45 PT) · workflow SSOT (W0–W8 · additive)**  
...
- SSOT：`w0-w8-workflow-status.md` · W0–W6 **`post_prove_dual_pass`** · **W1b** `harness/w1b-pg-redundant-retire-batches.md`（REQUEST-ready / not_run:pre_dual · ZERO DROP · no delete batch）· **W6** P0-CB+SCOR `harness/w6-p0-cb-scor-honesty.md`（post_prove_dual_pass · dual on `a6ca9e3` · W3 DELETE=503 freeze remains · ≠ product-complete）· **W7** E2E/NHP gap-close `harness/w7-e2e-nhp-matrix-gap-close.md`（REQUEST-ready / not_run:pre_dual · Ban covered without EXIT · Ban false green）· W8 not open · Dual PASS ≠ authorize coding · ≠HA · `releaseEvidence=false`
