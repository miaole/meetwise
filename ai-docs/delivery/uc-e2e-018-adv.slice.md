...
**Authority**: meetwise — **docs REQUEST open only** · status `executed:awaiting_post_prove_dual` · Ban secrets / `.env*` · Meridian banned · Ban Cloud Agent · Ban self-approve · Ban self-nail · Ban coding until dual+authorize · Ban invent covered · Ban flip §1.1 covered · Ban elevate ADV to partial this open · Ban wash ADV/SOLE/UI/TTL/GRAPH/FULL-E2E/HTTP/covered-lift/D2b/HA into covered · Ban skip to UC-011 · Ban messaging dual reviewers（coordinator dispatches）· **`haStatus=NOT_HA`** · **`releaseEvidence=false`** · **`claimProductionHA=false`**
...
**Experts**: `mw-e2e-ha` + `mw-rag-route` · pre-exec dual **BOTH PASS** · tips `ca7b18b` / `8c848fb` · post-prove dual awaiting · Ban自批 · Ban self-nail · Dual not pinged by implementer · coordinator dispatches
...
| Must cite | covered-lift refuse ADV blind · `adr-postgres-retained.md` · matrix UC-E2E-018 **partial** · §1.0 ADV **case-only→partial** · NHP-002-ADV-01 / NHP-011-ADV-01 · abandon HTTP / `uc018:abandon:http:prove` · P0-8 · Ban invent covered · Ban wash ADV into covered · Ban skip to UC-011 |
| NHP case | **NHP-018-ADV-01** in `non-happy-path-perf-load-case-matrix.md` · **case-only→partial** |
...
|--------|--------------|--------|
| `mw-e2e-ha` | `ai-docs/delivery/reviews/REQUEST-2026-09-23-uc-e2e-018-adv-mw-e2e-ha.md` | **PENDING / executed:awaiting_post_prove_dual** |
| `mw-rag-route` | `ai-docs/delivery/reviews/REQUEST-2026-09-23-uc-e2e-018-adv-mw-rag-route.md` | **PENDING / executed:awaiting_post_prove_dual** |
...
| Phase | This open |
|-------|-----------|
| L0 REQUEST `executed:awaiting_post_prove_dual` | **THIS OPEN** · parent `abfbbc0` · docs only · NHP-018-ADV-01 register + prove plan |
