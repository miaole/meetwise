...
| 题域 / RAG | **EG3 domainIsolationClosed under authorize**；**R4·FUNNEL product-close reassess honest flip under authorize**（`r4ProductClosed=true` · `funnelProductClosed=true` · `gR45Closed=false`）；**G-R4-5 aggregate closed under authorize**（`gR45Closed=true` · live `canHonestlyFlip` · ≠HA · ≠ cutover · ≠ suite）· **pass ≠ R4**；**不宣称 RAG 已切流**；**pass ≠ cutover** |
...
| **题域隔离（R4）** | **EG3 / 题域 isolation product face closed under authorize**（`domainIsolationClosed=true` · `eg3ProductClosed=true`）· track-local REAL-WIRE + G-R2-5 retained · **R4·FUNNEL product-close reassess honest flip**（`harness/g-r4-5-r4-funnel-product-close-reassess.md` · `executed:awaiting_post_prove_dual` · prior `pre_dual_pass` · tip `dc4180d` · EXIT 2×0 · `r4ProductClosed=true` · `funnelProductClosed=true` · coveredCount **8** Ban invent · `gR45Closed=false` · Ban self-nail · ARCHIVE prior non-flip `harness/g-r4-5-r4-funnel-product-close.md` retained）· **R4/FUNNEL product face closed under authorize** · **EG4 / wrong-track product face closed under authorize**（`eg4ProductClosed=true` · `wrongTrackProductClosed=true` · knife `harness/g-r4-5-eg4-wrong-track-product-close.md` · `executed:awaiting_post_prove_dual` · prior `pre_dual_pass` · tip `1b589af` · Ban flip gR45/r4/funnel · Ban self-nail）· **≠ gR45Closed** · **≠ invent coveredCount** · **≠ wrong_track=0 invent** · **MS3 ≠ R4** · 显式 **M4/M5 门** retained · `releaseEvidence=false` · ≠HA · knife EG3 `harness/g-r4-5-eg3-domain-isolation-product-close.md` · knife R4·FUNNEL reassess `harness/g-r4-5-r4-funnel-product-close-reassess.md` · **EG5 / product SSOT product face closed under authorize**（`eg5ProductClosed=true` · `productSsotFlipped=true` · knife `harness/g-r4-5-eg5-product-ssot-product-close.md` · `executed:awaiting_post_prove_dual` · prior `pre_dual_pass` · tip `95b3dd2` · Ban flip gR45/r4/funnel/eg3/eg4 · Ban self-nail）· **EG6 / MS3≠R4 product face closed under authorize**（`eg6ProductClosed=true` · `ms3EqualsR4Closed=false` retained · Ban claim R4 closed from MS3 · **no invented twin** · knife `harness/g-r4-5-eg6-ms3-ne-r4-product-close.md` · `executed:awaiting_post_prove_dual` · prior `pre_dual_pass` · tip `6ee0cd1` · Ban flip gR45/r4/funnel/eg3/eg4/eg5 · Ban flip `ms3EqualsR4Closed` · Ban self-nail）· **EG1 / dual-claim product face closed under authorize**（`eg1ProductClosed=true` · `gR45DualClaimClosed=true` · knife `harness/g-r4-5-eg1-dual-claim-product-close.md` · `executed:awaiting_post_prove_dual` · prior `pre_dual_pass` · tip `f2b6416` · Ban flip gR45/r4/funnel/eg3/eg4/eg5/eg6/`ms3EqualsR4Closed` · Ban invent coveredCount · Ban self-nail）· **EG2 / funnel-covered product face closed under authorize**（`eg2ProductClosed=true` · coveredCount **8** retained · Ban invent · knife `harness/g-r4-5-eg2-funnel-covered-product-close.md` · `executed:awaiting_post_prove_dual` · prior `pre_dual_pass` · tip `7c1bad1` · Ban flip gR45/eg1/dualClaim/r4/funnel/eg3–eg6/`ms3EqualsR4Closed` · Ban invent coveredCount · Ban self-nail）· knife EG4 `harness/g-r4-5-eg4-wrong-track-product-close.md` · knife EG5 `harness/g-r4-5-eg5-product-ssot-product-close.md`。 |
...
| 现状 | 门（可行动） | 关闭条件（本切片 **未关**） |
|------|--------------|---------------------------|
| track-local REAL-WIRE + G-R2-5 retrieve-side CLOSED retained；**EG3 / 题域 isolation product face closed under authorize**（`domainIsolationClosed=true` · `eg3ProductClosed=true` · `harness/g-r4-5-eg3-domain-isolation-product-close.md` · tip nail `7be1a55` · `post_prove_dual_pass`）；**R4·FUNNEL product-close reassess honest flip**（`harness/g-r4-5-r4-funnel-product-close-reassess.md` · `executed:awaiting_post_prove_dual` · `r4ProductClosed=true` · `funnelProductClosed=true` · coveredCount **8** Ban invent · `gR45Closed=false`）；ARCHIVE prior non-flip retained；prior EG3 evidence tip `62c0e2f` retained | **显式 M4/M5 门**：`gR45Closed=false` · **R4/FUNNEL product face closed under authorize** · **≠ G-R4-5 all closed** · **≠ invent coveredCount** · **≠ wrong_track=0 invent** · **MS3 ≠ R4** · 未满足前 **不得切题库/向量真相** | 题域 + R4/FUNNEL product face closed under authorize；不得宣称 G-R4-5 all closed / invent coveredCount / wash prior tips · `releaseEvidence=false` · ≠HA |

**本切片**：**EG3 / 题域 isolation product face closed under authorize**（`domainIsolationClosed=true` · `eg3ProductClosed=true`）；**R4·FUNNEL product-close reassess honest flip under authorize**（`r4ProductClosed=true` · `funnelProductClosed=true` · coveredCount **8** Ban invent · `productCloseFlipped=true` · Ban假关）；**EG4 / wrong-track product face closed under authorize**（`eg4ProductClosed=true` · `wrongTrackProductClosed=true` · Ban flip gR45/r4/funnel · Ban empty meta）；**EG5 / product SSOT product face closed under authorize**（`eg5ProductClosed=true` · `productSsotFlipped=true` · Ban flip gR45/r4/funnel/eg3/eg4 · Ban empty meta）；**EG6 / MS3≠R4 product face closed under authorize**（`eg6ProductClosed=true` · `ms3EqualsR4Closed=false` retained · Ban claim R4 closed from MS3 · **no invented twin** · Ban flip gR45/r4/funnel/eg3/eg4/eg5 · Ban empty meta）；**EG1 / dual-claim product face closed under authorize**（`eg1ProductClosed=true` · `gR45DualClaimClosed=true` · Ban flip gR45/r4/funnel/eg3–eg6 · Ban closing EG2 · Ban invent coveredCount · Ban empty meta）；**R4/FUNNEL + EG3 + EG4 + EG5 + EG6 + EG1 product faces closed under authorize**（EG6 retains `ms3EqualsR4Closed=false` · Ban claim R4 closed from MS3 · EG1 = `eg1ProductClosed=true` · `gR45DualClaimClosed=true` · Ban closing EG2） · **G-R4-5 aggregate closed under authorize**（`gR45Closed=true` · live `canHonestlyFlip` · Ban假关 · Ban wash prior tips alone · ≠HA · ≠ cutover · ≠ suite · `releaseEvidence=false` · knife `harness/g-r4-5-product-close.md` · `executed:awaiting_post_prove_dual` · prior `pre_dual_pass` · tip `4681b1a`）· Ban invent coveredCount · Ban wash ARCHIVE/Batch4b/EG3/R1/EG4 evidence/rem·SSOT·EXPLICIT · Ban self-nail `post_prove_dual_pass` · **partial scoped retrieve alone ≠ flip**。
