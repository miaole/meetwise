...
| 题域 / RAG | **EG3 domainIsolationClosed under authorize**；**R4·FUNNEL product-close reassess honest flip under authorize**（`r4ProductClosed=true` · `funnelProductClosed=true` · `gR45Closed=false`）；**≠ gR45Closed / G-R4-5 all closed**；**不宣称 RAG 已切流**；**pass ≠ cutover** |
...
**本切片**：**EG3 / 题域 isolation product face closed under authorize**（`domainIsolationClosed=true` · `eg3ProductClosed=true`）；**R4·FUNNEL product-close reassess honest flip under authorize**（`r4ProductClosed=true` · `funnelProductClosed=true` · coveredCount **8** Ban invent · `productCloseFlipped=true` · Ban假关）；**EG4 / wrong-track product face closed under authorize**（`eg4ProductClosed=true` · `wrongTrackProductClosed=true` · Ban flip gR45/r4/funnel · Ban empty meta）；**EG5 / product SSOT product face closed under authorize**（`eg5ProductClosed=true` · `productSsotFlipped=true` · Ban flip gR45/r4/funnel/eg3/eg4 · Ban empty meta）；**EG6 / MS3≠R4 product face closed under authorize**（`eg6ProductClosed=true` · `ms3EqualsR4Closed=false` retained · Ban claim R4 closed from MS3 · **no invented twin** · Ban flip gR45/r4/funnel/eg3/eg4/eg5 · Ban empty meta）；**EG1 / dual-claim product face closed under authorize**（`eg1ProductClosed=true` · `gR45DualClaimClosed=true` · Ban flip gR45/r4/funnel/eg3–eg6 · Ban closing EG2 · Ban invent coveredCount · Ban empty meta）；**R4/FUNNEL + EG3 + EG4 + EG5 + EG6 + EG1 product faces closed under authorize**（EG6 retains `ms3EqualsR4Closed=false` · Ban claim R4 closed from MS3 · EG1 = `eg1ProductClosed=true` · `gR45DualClaimClosed=true` · Ban closing EG2） · **G-R4-5 STILL OPEN**（`gR45Closed=false` · default do NOT auto-flip）· Ban invent coveredCount · Ban wash ARCHIVE/Batch4b/EG3/R1/EG4 evidence/rem·SSOT·EXPLICIT · Ban self-nail `post_prove_dual_pass` · **partial scoped retrieve alone ≠ flip**。
