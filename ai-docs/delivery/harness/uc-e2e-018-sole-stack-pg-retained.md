...
**Prior GRAPH safely_terminated（CLOSED prior · retained · ≠ wash into UC covered / #6）**: `harness/uc-e2e-018-graph-safely-terminated.md` · tip nail **`08650ea`** / full `08650ea37a7c8b120d6f8187ba40a47fc741daae` · `post_prove_dual_pass` · `GAP-UC018-GRAPH` **CLOSED only** · matrix still **partial** · **≠ UC-E2E-018 covered** · **≠ sole PG-retained dedicated nail** · **retained** · Ban wash into #6 / UC covered
**Prior TTL sweeper abandon（CLOSED prior · retained · ≠ wash into UC covered / #6）**: `harness/uc-e2e-018-ttl-sweeper-abandon.md` · tip nail **`d698282`** / full `d698282f0dc5835573a84d1fb885ad03104a2a88` · `post_prove_dual_pass` · `GAP-UC018-TTL` **CLOSED only** · matrix still **partial** · **≠ UC-E2E-018 covered** · **≠ sole PG-retained dedicated nail** · **retained** · Ban wash into #6 / UC covered
...
| **≠ wash UI into #6 / UC covered** | **YES** — parent tip **`1990b12`** UI nail CLOSED · matrix still **partial** · **≠** sole PG-retained dedicated · **≠** UC-E2E-018 covered · **retained** · Ban wash · Ban reopen UI · **must be ancestor** |
| **≠ wash TTL into #6 / UC covered** | **YES** — tip **`d698282`** TTL nail CLOSED · matrix still **partial** · **≠** sole dedicated · **≠** UC covered · **retained** · Ban wash · Ban reopen TTL |
| **≠ wash GRAPH into #6 / UC covered** | **YES** — tip **`08650ea`** GRAPH nail CLOSED · matrix still **partial** · **≠** sole dedicated · **≠** UC covered · **retained** · Ban wash · Ban reopen GRAPH |
| **≠ wash FULL-E2E into #6 / UC covered** | **YES** — tip **`c36b032`** FULL-E2E nail CLOSED · matrix still **partial** · **≠** sole dedicated · **≠** UC covered · **retained** · Ban wash · Ban reopen FULL-E2E |
| **≠ wash abandon HTTP / db / UI / graph / ttl into #6** | **YES** — existing prove EXIT=0 = user-abandon / full.e2e / AiGraphRun / TTL / UI only · **≠** PG-retained sole honesty dedicated nail · **retained** · Ban wash |
| **≠ wash D2b / HA into E2E covered** | **YES** — D2b nail **`7fddebe`** CLOSED · still NOT_HA · releaseEvidence=false · claimProductionHA=false · liveGhaRunUrl orthogonal · **≠** UC-E2E-018 covered · **≠** #6 closed · **retained** · Ban wash · Ban reopen D2b |
| **≠ claim R5 retired globally** | **YES** — STOPPED R5 harnesses superseded for cutover · this knife does **not** claim global R5 retirement · Ban reopen Qdrant-required path |
...
## 1. Acceptance · §1b #6 only（document for later coding · PG-retained）

| # | Gap | Acceptance criteria（later under AUTHORIZED coding+prove · **not this open**） | Why priors / legacy do **not** auto-close | This REQUEST |
|---|-----|--------------------------------------------------------------------------------|-------------------------------------------|--------------|
| **A1** | Pre-exec dual | Pre-exec dual `mw-e2e-ha` + `mw-rag-route` **BOTH PASS** on REQUEST tip **before** any coding / prove / stack edit | N/A | **PASS** retained（`7e29e28` / `31e7eff`）· Ban自批 |
| **A2** | Re-align §1b #6 under PG-retained | Sole-stack for this UC = default isolated **Postgres+pgvector**（retained production-aligned per `adr-postgres-retained.md`）· **remove** false close-condition that UC-018 needs mysql-qdrant-redis fixture swap to discuss covered | Legacy MySQL+Qdrant+Redis text **SUPERSEDED** · STOPPED R5 harnesses ≠ reopen | **honesty rewrite this open** · Ban cutover coding |
| **A3** | Dedicated honesty prove（cite PG-retained） | Later: honesty CMD(s) asserting UC-018 abandon family proves **cite PG-retained sole**（Postgres+pgvector · not MySQL/Qdrant sole-wiring）· receipts required · Ban wash sole-wiring EXIT | Prior UI/TTL/GRAPH/FULL-E2E/HTTP EXIT=0 ≠ dedicated sole honesty nail · MySQL/Qdrant sole-wiring ≠ this gap | **CMD plan named** · Ban run this open |
| **A4** | Parent harness + eval + matrix honesty | Later: update `harness/uc-e2e-018-user-abandon.md` + `eval/uc-e2e-018-user-abandon.eval.md` + matrix row honesty: close **`GAP-UC018-SOLE` only** · matrix stays **partial** · Ban claim UC covered · Ban MySQL/Qdrant as close-condition | Writing REQUEST ≠ gap closed | **honesty name OPEN this open** · Ban rewrite as UC covered |
...
**Dedicated coding+prove pattern（later under authorize · cite parent harness §1b #6 · GAP-UC018-SOLE · PG-retained）**:

| CMD / deliverable | Role | Honest read when EXIT=0 |
|-------------------|------|-------------------------|
| Honesty: UC-018 abandon family proves **cite PG-retained sole**（default isolated Postgres+pgvector · production-aligned） | §1b #6 / `GAP-UC018-SOLE` | Sole honesty nailed · **≠** UC covered alone · matrix stays **partial** · **#6 alone ≠ covered** |
| Dedicated honesty prove CMD(s) asserting **PG-retained** cite（**Ban** wash from MySQL/Qdrant sole-wiring EXIT） | close `GAP-UC018-SOLE` **only** | Ban wash from UI/TTL/GRAPH/FULL-E2E/HTTP EXIT=0 · Ban wash sole-wiring · Ban claim covered · Ban claim R5 retired globally |
| Update `harness/uc-e2e-018-user-abandon.md` + eval + matrix honesty | close `GAP-UC018-SOLE` **only** | Ban claim covered · Ban MySQL/Qdrant close-condition |
| `pnpm uc018:abandon:prove` | retained regression | EXIT=**0** · still ≠ covered · still ≠ #6 alone |
| `pnpm uc018:abandon:http:prove` | retained regression | EXIT=**0** · still ≠ covered · ≠ sole dedicated |
| `pnpm uc018:abandon:full-e2e:prove` | retained regression | EXIT=**0** · FULL-E2E already CLOSED · still ≠ covered · ≠ sole |
| `pnpm uc018:graph:prove` | retained regression | EXIT=**0** · GRAPH already CLOSED · still ≠ covered · ≠ sole |
| `pnpm uc018:ttl:prove` | retained regression | EXIT=**0** · TTL already CLOSED · still ≠ covered · ≠ sole |
| `pnpm uc018:ui:prove` | retained regression | EXIT=**0** · UI already CLOSED · still ≠ covered · ≠ sole |
| New dedicated sole PG-retained honesty prove CMD(s)（name in coding phase） | new path | EXIT=**0** with receipts · closes `GAP-UC018-SOLE` only · still ≠ covered · Ban MySQL/Qdrant sole-wiring as evidence |
| D2b / HA / liveGhaRunUrl / GRAPH / FULL-E2E / TTL / UI nails · STOPPED R5 harnesses | orthogonal / superseded retained | **not** E2E covered evidence · Ban wash · Ban reopen cutover |
...
|-------|--------------|--------|--------------|
| **UC-E2E-018 UI abandon** | tip nail **`1990b12`** / full `1990b1266400ff93182c040c61b7b30c4830f1ed` | `post_prove_dual_pass` · `GAP-UC018-UI` **CLOSED only** · matrix still **partial** · ≠ UC covered · ≠ sole dedicated · **CLOSED** · **retained** · **must be ancestor** | **≠** wash into #6 closed / UC covered · Ban reopen |
| **UC-E2E-018 TTL sweeper abandon** | tip nail **`d698282`** / full `d698282f0dc5835573a84d1fb885ad03104a2a88` | `post_prove_dual_pass` · `GAP-UC018-TTL` **CLOSED only** · matrix still **partial** · ≠ UC covered · ≠ sole dedicated · **CLOSED** · **retained** | **≠** wash into #6 closed / UC covered · Ban reopen |
| **UC-E2E-018 AiGraphRun safely_terminated** | tip nail **`08650ea`** / full `08650ea37a7c8b120d6f8187ba40a47fc741daae` | `post_prove_dual_pass` · `GAP-UC018-GRAPH` **CLOSED only** · matrix still **partial** · ≠ UC covered · ≠ sole dedicated · **CLOSED** · **retained** | **≠** wash into #6 closed / UC covered · Ban reopen |
| **UC-E2E-018 full.e2e abandon inclusion** | tip nail **`c36b032`** / full `c36b032b4db5ddfa89dc6295395f4ac928b96583` | `post_prove_dual_pass` · `GAP-UC018-FULL-E2E` **CLOSED only** · matrix still **partial** · ≠ UC covered · ≠ sole · **CLOSED** · **retained** | **≠** wash into #6 closed / UC covered · Ban reopen |
| **UC-E2E-018 user-abandon（partial）** | harness `uc-e2e-018-user-abandon.md` · `uc018:abandon:prove` + `uc018:abandon:http:prove` · waiting_user CLOSED | matrix **partial** · ≠ covered · §1b #6 sole **OPEN**（re-aligned）· **retained** | **≠** wash into #6 closed / UC covered |
| **HA D2b live GHA probe:multi artifact** | tip nail **`7fddebe`** | `post_prove_dual_pass` · still NOT_HA · releaseEvidence=false · claimProductionHA=false · **CLOSED** · **do not reopen** | **≠** wash into UC-E2E-018 covered / #6 |
| **PG-retained ADR / checkpoint docs** | `adr-postgres-retained.md` · `harness/pg-retained-checkpoint-postgres-saver.md` | accepted direction pin · Dual PASS ≠ coding · Ban MySQL/Qdrant cutover | **cite** · Ban implement cutover from docs dual alone |
| **STOPPED R5 retirement / mark-red** | `harness/r5-retirement-sole-stack-status.md` · `harness/r5-pgvector-fixture-mark-red.md` | **STOPPED / superseded** · historical MySQL+Qdrant sole · Ban reopen Qdrant-required | **cite STOPPED** · Ban wash as #6 close · Ban reopen cutover |
| **MySQL/Qdrant sole-wiring proves** | `mysql-stack:*` / `e2e-isolation:sole-*:prove` | historical/experimental · ≠ PG-retained UC sole · ≠ this gap | **Ban wash** as `GAP-UC018-SOLE` evidence |
| **UC covered / matrix covered / releaseEvidence / HA / R5 retired globally** | — | **NOT claimed** | Ban假绿 · Ban invent green · Ban pre-claim this open · Ban #6 alone = covered |
...
|-----|--------|----------------|
| `pnpm uc018:abandon:prove` | EXIT **0** retained | see prove receipt / EXIT table below |
| `pnpm uc018:abandon:http:prove` | EXIT **0** retained | see EXIT table |
| `pnpm uc018:abandon:full-e2e:prove` | EXIT **0** retained（FULL-E2E already CLOSED） | see EXIT table |
| `pnpm uc018:graph:prove` | EXIT **0** retained（GRAPH already CLOSED） | see EXIT table |
| `pnpm uc018:ttl:prove` | EXIT **0** retained（TTL already CLOSED） | see EXIT table |
| `pnpm uc018:ui:prove` | EXIT **0** retained（UI already CLOSED） | see EXIT table |
| `pnpm uc018:sole:prove` → `scripts/uc-e2e-018-sole-stack-pg-retained.proof.mjs` | EXIT **0** · closes `GAP-UC018-SOLE` only · Ban wash MySQL/Qdrant sole-wiring | **dedicated** · see EXIT table |
| `pnpm eval-harness-matrix-cite:prove` | EXIT **0** · cite pins include `uc018:sole:prove` + PG-retained / GAP-UC018-SOLE | see EXIT table |
| `pnpm mysql-stack:*` / `e2e-isolation:sole-*:prove` | **NOT** evidence for this gap | **Ban wash** · Ban run as #6 prove |

### EXIT table（2026-09-23 ~18:05 PT · Ban invent）

| CMD | EXIT | Honest read |
|-----|------|-------------|
| `pnpm uc018:sole:prove` | **0** | closes `GAP-UC018-SOLE` only · #6 alone ≠ covered · Ban wash MySQL/Qdrant sole-wiring |
| `pnpm uc018:abandon:prove` | **0** | retained · ≠ covered |
| `pnpm uc018:abandon:http:prove` | **0** | retained · ≠ covered · ≠ sole |
| `pnpm uc018:abandon:full-e2e:prove` | **0** | retained · FULL-E2E CLOSED · ≠ covered |
| `pnpm uc018:graph:prove` | **0** | retained · GRAPH CLOSED · ≠ covered |
| `pnpm uc018:ttl:prove` | **0** | retained · TTL CLOSED · ≠ covered |
| `pnpm uc018:ui:prove` | **0** | retained · UI CLOSED · ≠ covered · UI alone ≠ covered |
| `pnpm eval-harness-matrix-cite:prove` | **0** | cite honesty · UC-E2E-018 **partial** · lists `uc018:sole:prove` + PG-retained / GAP-UC018-SOLE |
