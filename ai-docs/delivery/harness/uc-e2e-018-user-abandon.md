...
| `pnpm uc018:covered-lift-reassess:prove` | **0** | **GAP-UC018-COVERED-LIFT-REASSESS** · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind** · §1.1 stays **partial** · Ban假关 · Ban invent green · Ban wash ADV/SOLE alone into covered · Ban claim PERF/LOAD closed · Ban skip to UC-011 · nail `post_prove_dual_pass` · prove tip `5cddb53` · post-prove dual `14a1859`/`7f57243` |
| `pnpm uc018:perf-load:prove`（plan only · **not_run** this open） | later **0** under authorize | **NHP-018-PERF-01**+**NHP-018-LOAD-01** · elevate §1.0 PERF/LOAD **case-only→partial**（THIS UC only）· EXIT=0 only if thresholds met · **PERF/LOAD partial ≠ covered** · Ban invent green · Ban post-hoc retune · Ban claim production capacity / HA · Ban flip §1.1 covered · Ban skip to UC-011 |
