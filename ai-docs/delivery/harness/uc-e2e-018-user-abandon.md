...
| `pnpm uc018:covered-lift-reassess:prove`（plan only · **not_run** this open） | later **0** under authorize | **GAP-UC018-COVERED-LIFT-REASSESS** · **canHonestlyFlip** reassess · flip §1.1 **partial→covered**（THIS UC only）**only if** affirmed · else stay **partial** + refuse pin · Ban invent green · Ban wash ADV/SOLE alone into covered · Ban claim PERF/LOAD closed · Ban skip to UC-011 |
