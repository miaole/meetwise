...
| `pnpm uc018:covered-lift-reassess:prove` | **0** | **GAP-UC018-COVERED-LIFT-REASSESS** · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind** · §1.1 stays **partial** · Ban假关 · Ban invent green · Ban wash ADV/SOLE alone into covered · Ban claim PERF/LOAD closed · Ban skip to UC-011 · Ban self-nail · `executed:awaiting_post_prove_dual` |
