...
| 假绿禁令 | 不得把本绿写成「UC-E2E-018 covered」；FULL-E2E+GRAPH+TTL+UI+#6 SOLE(PG-retained) 已关仍 ≠ covered（**#6 alone ≠ covered** · 矩阵仍 **partial** · covered-lift assessed `harness/uc-e2e-018-covered-lift.md` · status `post_prove_dual_pass` · `GAP-UC018-COVERED-LIFT` CLOSED as honest non-flip assessment only · **≠ UC covered** · **canHonestlyFlip=false** · refuse：matrix §1.0 ADV was **blind** · tip `abfbbc0` · Ban假关 · Ban invent covered · Ban wash SOLE alone into covered）· **ADV nailed** `harness/uc-e2e-018-adv.md` · tip `27dd6ae` · `GAP-UC018-ADV` **CLOSED** · **NHP-018-ADV-01** **partial** · status `post_prove_dual_pass` · prove tip `bdc5993` · post-prove dual `5690779`/`9300d48` · **ADV alone ≠ covered** · Ban wash ADV into covered · §1.0 ADV **partial** · Ban flip §1.1 covered · Ban claim PERF/LOAD closed）· **covered-lift-reassess nailed** `harness/uc-e2e-018-covered-lift-reassess.md` · `GAP-UC018-COVERED-LIFT-REASSESS` CLOSED as honest non-flip assessment only · status `post_prove_dual_pass` · prove tip `5cddb53` · post-prove dual `14a1859`/`7f57243` · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind** · `pnpm uc018:covered-lift-reassess:prove` · Ban invent covered · Ban wash ADV alone into covered · Ban假关 · Ban claim PERF/LOAD closed · Ban skip to UC-011  · **PERF/LOAD nailed** `harness/uc-e2e-018-perf-load.md` · `GAP-UC018-PERF-LOAD` **CLOSED** · **NHP-018-PERF-01**+**NHP-018-LOAD-01** **partial** · status `post_prove_dual_pass` · prove tip `b29c191` · dual `1745bee`/`37c89dc`+`e33dd63` · **PERF/LOAD partial ≠ UC covered** · §1.1 stays partial · **workerCapEnforced=false** · Ban invent covered · Ban claim production capacity / HA · Ban skip to UC-011 · Ban cite canHonestlyFlip@b29c191 as assessed（constant-false no-flip guard） |
| 本绿≠全链路 E2E covered | **必须钉死**；`GAP-UC018-FULL-E2E`+#2 GRAPH+#3 TTL+#5 UI+#6 `GAP-UC018-SOLE`（PG-retained）已关 · **#6 alone ≠ covered** → 矩阵仍 **partial** · **≠ covered** · Ban elevating without AUTHORIZED covered-lift-reassess · covered-lift assessed（`harness/uc-e2e-018-covered-lift.md` · `post_prove_dual_pass` · tip `abfbbc0` · `GAP-UC018-COVERED-LIFT` CLOSED as honest non-flip assessment only · **≠ UC covered** · **canHonestlyFlip=false** · refuse ADV was **blind** · Ban假关 · Ban invent covered）· **ADV nailed**（`harness/uc-e2e-018-adv.md` · tip `27dd6ae` · `post_prove_dual_pass` · `GAP-UC018-ADV` **CLOSED** · **NHP-018-ADV-01** **partial** · prove tip `bdc5993` · post-prove dual `5690779`/`9300d48` · **ADV alone ≠ covered** · Ban wash ADV into covered · Ban claim PERF/LOAD closed）· **covered-lift-reassess nailed**（`harness/uc-e2e-018-covered-lift-reassess.md` · `post_prove_dual_pass` · CLOSED as honest non-flip assessment only · prove tip `5cddb53` · post-prove dual `14a1859`/`7f57243` · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind** · Ban invent covered · Ban假关 · Ban skip to UC-011）  · **PERF/LOAD nailed**（`harness/uc-e2e-018-perf-load.md` · `post_prove_dual_pass` · `GAP-UC018-PERF-LOAD` **CLOSED** · **NHP-018-PERF-01**+**NHP-018-LOAD-01** **partial** · prove tip `b29c191` · Ban invent covered · Ban skip to UC-011 · PERF/LOAD partial ≠ covered） |
...
| `pnpm uc018:adv:prove` | **0** · executed · `post_prove_dual_pass` · `GAP-UC018-ADV` **CLOSED** | **NHP-018-ADV-01** **partial** · §1.0 ADV **partial**（THIS column only）· prove tip `bdc5993` · post-prove dual `5690779`/`9300d48` · tip `27dd6ae` · **ADV alone ≠ covered** · Ban invent green · Ban wash ADV into covered · Ban flip §1.1 covered · Ban claim PERF/LOAD closed |
| `pnpm uc018:covered-lift-reassess:prove` | **0** | **GAP-UC018-COVERED-LIFT-REASSESS** · at prove tip `5cddb53` **canHonestlyFlip** was **computed** false · refuse then：**PERF/LOAD blind** · nail `0b7a218` · at `b29c191` script became **constant-false no-flip guard（not an assessment）** · Ban 「assessed, cannot flip」· §1.1 stays **partial** · Ban假关 · Ban invent green · Ban wash ADV/SOLE alone into covered · Ban skip to UC-011 · post-prove dual `14a1859`/`7f57243` |
| `pnpm uc018:perf-load:prove` | **0** · executed · `post_prove_dual_pass` · `GAP-UC018-PERF-LOAD` **CLOSED** | **NHP-018-PERF-01**+**NHP-018-LOAD-01** **partial** · §1.0 PERF/LOAD **partial**（THIS UC only）· prove tip `b29c191` · dual `1745bee`/`37c89dc`+`e33dd63` · **PERF/LOAD partial ≠ covered** · **workerCapEnforced=false** · Ban invent green · Ban claim production capacity / HA · Ban flip §1.1 covered · Ban skip to UC-011 |
...
| 「MySQL+Qdrant+Redis sole-wiring / `e2e-isolation:sole-*:prove` 绿 = #6 / UC covered」 / 「UI/TTL/GRAPH/FULL-E2E 绿 = `GAP-UC018-SOLE` closed」 / 「`uc018:sole:prove` 绿 = UC-E2E-018 covered」 / 「R5 mark-red EXIT=0 = R5 retired globally」 / 「§1b #1–#6 已关 = UC covered / REQUEST open = covered」 / 「ADV partial / ADV nail = UC covered」 | **假绿**。§1b #6 **CLOSED under PG-retained**（`adr-postgres-retained.md` · `pnpm uc018:sole:prove` · tip **`aa968b1`**）· sole = 默认 isolated Postgres+pgvector · **Ban** MySQL/Qdrant sole-wiring 冒充本缺 · **Ban** wash UI/`1990b12`/TTL/GRAPH/FULL-E2E alone as #6 closed · `GAP-UC018-SOLE` **CLOSED only** · **#6 alone ≠ covered** · 矩阵仍 **partial** · Ban claim UC covered · Ban invent covered · Ban假关 · covered-lift assessed（`harness/uc-e2e-018-covered-lift.md` · tip `abfbbc0` · `post_prove_dual_pass` · `GAP-UC018-COVERED-LIFT` CLOSED as honest non-flip assessment only · **≠ UC covered**）· **canHonestlyFlip=false** · refuse ADV was **blind** · Ban假关 · **ADV nailed**（`harness/uc-e2e-018-adv.md` · tip `27dd6ae` · `post_prove_dual_pass` · `GAP-UC018-ADV` **CLOSED** · **NHP-018-ADV-01** **partial** · prove tip `bdc5993` · post-prove dual `5690779`/`9300d48` · **ADV alone ≠ covered** · Ban wash ADV into covered · Ban claim PERF/LOAD closed）· **covered-lift-reassess nailed**（`harness/uc-e2e-018-covered-lift-reassess.md` · `post_prove_dual_pass` · CLOSED as honest non-flip assessment only · prove tip `5cddb53` · post-prove dual `14a1859`/`7f57243` · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind** · Ban invent covered · Ban假关 · Ban skip to UC-011）· Ban claim R5 retired globally · Ban restore mysql-qdrant-redis as close-condition · STOPPED `harness/r5-retirement-sole-stack-status.md` / `r5-pgvector-fixture-mark-red.md`  · **PERF/LOAD nailed**（`harness/uc-e2e-018-perf-load.md` · **partial** · `post_prove_dual_pass` · GAP CLOSED · Ban invent covered · Ban skip to UC-011） |
...
| P0-8 | 集成+HTTP+**full.e2e abandon**+**graph**+**ttl**+**UI**+**sole PG-retained** prove 已挂（含 waiting_user CAS + FULL-E2E + GRAPH + TTL + `GAP-UC018-UI` + `GAP-UC018-SOLE` · `pnpm uc018:sole:prove` · tip **`aa968b1`**）；§1b #6 **CLOSED under PG-retained** · Ban MySQL/Qdrant cutover · covered-lift assessed（`harness/uc-e2e-018-covered-lift.md` · tip `abfbbc0` · `post_prove_dual_pass` · `GAP-UC018-COVERED-LIFT` CLOSED as honest non-flip assessment only · **≠ UC covered** · **canHonestlyFlip=false** · refuse ADV was **blind** · Ban假关 · Ban invent covered）· **ADV nailed**（`harness/uc-e2e-018-adv.md` · tip `27dd6ae` · `post_prove_dual_pass` · `GAP-UC018-ADV` **CLOSED** · **NHP-018-ADV-01** **partial** · prove tip `bdc5993` · post-prove dual `5690779`/`9300d48` · **ADV alone ≠ covered** · Ban claim PERF/LOAD closed）· **covered-lift-reassess nailed**（`harness/uc-e2e-018-covered-lift-reassess.md` · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind** · Ban invent covered · Ban假关 · Ban skip to UC-011） | 见矩阵 §3 · harness §1b · 仍 **partial** · UI alone ≠ covered · **#6 alone ≠ covered** · ≠ UC covered · **ADV alone ≠ covered** · Ban假关  · **PERF/LOAD nailed**（`harness/uc-e2e-018-perf-load.md` · **NHP-018-PERF-01**+**NHP-018-LOAD-01** **partial** · `post_prove_dual_pass` · GAP CLOSED · Ban skip to UC-011） |
