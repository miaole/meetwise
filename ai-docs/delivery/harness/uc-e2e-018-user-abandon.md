...
| `pnpm uc018:adv:prove` | **0** · executed · `post_prove_dual_pass` · `GAP-UC018-ADV` **CLOSED** | **NHP-018-ADV-01** **partial** · §1.0 ADV **partial**（THIS column only）· prove tip `bdc5993` · post-prove dual `5690779`/`9300d48` · **ADV alone ≠ covered** · Ban invent green · Ban wash ADV into covered · Ban flip §1.1 covered · Ban skip to UC-011 · Ban claim PERF/LOAD closed |
