...
| 假绿禁令 | 不得把本绿写成「UC-E2E-018 covered」；FULL-E2E+GRAPH+TTL+UI+#6 SOLE(PG-retained) 已关仍 ≠ covered（**#6 alone ≠ covered** · 矩阵仍 **partial** · covered-lift REQUEST `harness/uc-e2e-018-covered-lift.md` · status `draft:awaiting_pre_exec_dual` · Ban invent covered · Ban flip covered this open） |
| 本绿≠全链路 E2E covered | **必须钉死**；`GAP-UC018-FULL-E2E`+#2 GRAPH+#3 TTL+#5 UI+#6 `GAP-UC018-SOLE`（PG-retained）已关 · **#6 alone ≠ covered** → 矩阵仍 **partial** · **≠ covered** · Ban elevating without AUTHORIZED covered-lift · covered-lift REQUEST OPEN（`harness/uc-e2e-018-covered-lift.md` · `draft:awaiting_pre_exec_dual` · Ban invent covered · Ban flip covered this open） |
...
| P0-8 | 集成+HTTP+**full.e2e abandon**+**graph**+**ttl**+**UI**+**sole PG-retained** prove 已挂（含 waiting_user CAS + FULL-E2E + GRAPH + TTL + `GAP-UC018-UI` + `GAP-UC018-SOLE` · `pnpm uc018:sole:prove` · tip **`aa968b1`**）；§1b #6 **CLOSED under PG-retained** · Ban MySQL/Qdrant cutover · covered-lift REQUEST OPEN（`harness/uc-e2e-018-covered-lift.md` · `draft:awaiting_pre_exec_dual` · Ban invent covered · Ban flip covered this open） | 见矩阵 §3 · harness §1b · 仍 **partial** · UI alone ≠ covered · **#6 alone ≠ covered** · ≠ UC covered · Ban假关 |
