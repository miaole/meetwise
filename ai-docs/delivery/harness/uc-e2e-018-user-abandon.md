...
| `pnpm uc018:covered-lift:prove` | **0** | 静态诚实：§1b #1–#6 CLOSED cite + **canHonestlyFlip=false**（refuse：matrix §1.0 ADV **blind**）；矩阵仍 **partial**；Ban假关 · Ban wash SOLE alone into covered |
