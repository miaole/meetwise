...
| `pnpm uc018:adv:prove` | **0** · executed · awaiting_post_prove_dual | **NHP-018-ADV-01** · §1.0 ADV **case-only→partial**（THIS column only）· **ADV alone ≠ covered** · Ban invent green · Ban wash ADV into covered · Ban flip §1.1 covered · Ban skip to UC-011 |
