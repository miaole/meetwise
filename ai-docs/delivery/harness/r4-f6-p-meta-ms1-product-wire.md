# Harness — Knife **F6** · **MS1 MetadataReviewReceipt product wire**（**`executed:awaiting_post_prove_dual`**）
...
**Experts**: `mw-e2e-ha` + `mw-rag-route`（pre-exec dual **PASS** · coding+prove **executed** · prove **EXIT=0** · **await post-prove dual** · **no self-approve**）  
...
**Authority**: meetwise — F5 = **`post_prove_dual_pass`**（honesty only · product contract/plan/checklist **named**）· F6 pre-exec dual **PASS** + authorize coding+prove · **MS1 product consumer WIRED**（`routedServingProductConsumerWired=true` · contract.wired=true · ≠ forge）· **MS2/MS3 still false** · **G-R4-5 STILL OPEN** · wiring MS1 alone **≠** FUNNEL-01/R4/R1 closed ≠ HA ≠ suite green ≠ G-R4-5 closed · **releaseEvidence=false** · **Ban forge serving** · **Ban claiming R4/FUNNEL/R1 closed** · **Ban flip without authorize** · **Ban self-approve** · **≠ post_prove_dual_pass yet**（experts must review）
...
| **What this knife is not** | Not R4 close · not 题域已隔离 · not FUNNEL-01 closed · not R1 closed · not MS2 facets path · not MS3 deploy handoff · not P-R1 fail-closed flip · not MODEL-OP · **not** forge serving · **not** self-approve post-prove |
...
| **Now** | Coding+prove **executed** · `pnpm r4-p-meta-ms1-product-wire:prove` **EXIT=0** · status **`executed:awaiting_post_prove_dual`** · **await expert post-prove dual** |
...
| **M4** | Prove CMD frozen · **executed** · EXIT=0 | **met**（implementer ~00:45 PT · await expert re-run） |
| **M5** | Coding gate: F1–F5 dual-closed · F6 pre-exec dual PASS + authorize | **met** |
| **M6** | Post-prove REQUEST pair drafted · no self-approve · await post-prove dual | **REQUEST drafted · awaiting** |

### CMD

| CMD | Role | Status |
|-----|------|--------|
| **`pnpm r4-p-meta-ms1-product-wire:prove`** | MS1 product wire prove | **EXIT=0** · MS1 wired · MS2/MS3 still false · ≠ FUNNEL-01/R4/G-R4-5 closed |
...
| model-op | — | — | **omitted** |
| post-prove | `mw-e2e-ha` | `reviews/REQUEST-2026-09-17-r4-f6-p-meta-ms1-product-wire-post-prove-mw-e2e-ha.md` | **drafted · await** |
| post-prove | `mw-rag-route` | `reviews/REQUEST-2026-09-17-r4-f6-p-meta-ms1-product-wire-post-prove-mw-rag-route.md` | **drafted · await** |
...
- **≠ post_prove_dual_pass yet** · experts must independently re-run prove  
...
## 6. Implementer prove record

| CMD | EXIT | Read |
|-----|------|------|
| `pnpm r4-p-meta-ms1-product-wire:prove` | **0** | MS1 wired · MS2/MS3 still false · F5 spawn EXIT=0 · ≠ FUNNEL-01/R4/G-R4-5 closed · await post-prove dual |
...
**Next**: expert post-prove dual（e2e-ha + rag-route）· **Ban self-approve** · **≠ claim post_prove_dual_pass**.

---

*Harness · F6 MS1 MetadataReviewReceipt product wire · 2026-09-17 ~00:45 PT · executed:awaiting_post_prove_dual · prove EXIT=0 · MS1 wired · MS2/MS3 still false · G-R4-5 STILL OPEN · G-R4-3 STILL OPEN · releaseEvidence=false · ≠HA · ≠ R4 closed · ≠ FUNNEL-01 closed · sole 恰 5 · Ban forge · Ban flip without authorize · Ban self-approve · await post-prove dual*
