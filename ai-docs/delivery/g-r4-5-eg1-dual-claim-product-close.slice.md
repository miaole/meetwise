...
| Role | Path |
|------|------|
| This slice | `ai-docs/delivery/g-r4-5-eg1-dual-claim-product-close.slice.md` |
| Harness | `ai-docs/delivery/harness/g-r4-5-eg1-dual-claim-product-close.md` |
| Eval | `ai-docs/delivery/eval/g-r4-5-eg1-dual-claim-product-close.eval.md`（later / experts · **not** this open） |
| Prior EG1+EG2 true-evidence / impl | `harness/g-r4-5-eg1-eg2-true-evidence-impl.md` · tip nail **`08f7499`** · dual/prove **`ffb2a9b`** · EXIT **2×0** · **`post_prove_dual_pass`** · EG1 **STILL OPEN** · `gR45DualClaimClosed=false` · **retained OPEN evidence** · **≠** this knife · Ban closing EG2 |
| Prior EG6 product close | `harness/g-r4-5-eg6-ms3-ne-r4-product-close.md` · tip nail **`315570d`** · prove **`757fbe1`** · `eg6ProductClosed=true` · `ms3EqualsR4Closed=false` **retained** · **retained** · Ban flip eg6/`ms3EqualsR4Closed`/`gR45Closed` this knife |
...
Docs REQUEST open: **G-R4-5 / EG1 dual-claim product close** · MetadataReviewReceipt / RAG-FUNNEL-01 · 01A≡01 face · flip `eg1ProductClosed` and/or `gR45DualClaimClosed` under standing authorize + authorized SSOT (GAP-RAG-04 / m4 §R4 / w0-w8 / product-ssot / EG1 harness) · if evidence sufficient → honest flip · else honest non-flip · intended dedicated prove may use proposed `pnpm r4-eg1-dual-claim-product-close:prove` **or** extend prior EG1 path **+** `pnpm mysql-stack:r4-domain-isolation:prove` **later** · EXIT expected **2×0** · EXIT=0 ≠ G-R4-5 all closed ≠ HA · **Ban** flip `gR45Closed` · **Ban** closing EG2 · Ban invent coveredCount · Ban wash EG1 `08f7499`/`ffb2a9b` or EG6 `315570d`/`757fbe1` or EG5 `33f457b`/`7f59b95` or EG4 `ce09850`/`0a34933` or R4·FUNNEL `2b38e18`/`14e9e2c` or EG3 `7be1a55`/`5b3c854` · Ban MS3=R4 · Ban empty meta prove · Ban idle re-run only `pnpm r4-eg1-dual-claim:prove` as fake product close · post-prove dual BOTH PASS → nail → STOP · Dual PASS ≠ next knife auto-authorize · Key×3 O3 honesty_red非阻塞 · retain r4/funnel/EG3/EG4/EG5/EG6 · retain `ms3EqualsR4Closed=false` · Ban silent flip · Dual PASS ≠ coding · `eg1ProductClosed=false` · `gR45DualClaimClosed=false` · `gR45Closed=false` · `releaseEvidence=false` · ≠HA · **G-R4-5 STILL OPEN** · zero coding · zero prove · zero flip.

## Hard pins

- **EG1 / dual-claim STILL OPEN** · **G-R4-5 STILL OPEN** · **EG2 STILL OPEN** · **MS3 ≠ R4 closed** · ≠ EG1 wash `08f7499`/`ffb2a9b` · ≠ EG6 wash `315570d`/`757fbe1` into EG1/gR45 · ≠ EG5 wash `33f457b`/`7f59b95` into EG1/gR45 · ≠ EG4 wash `ce09850`/`0a34933` into EG1/gR45 · ≠ R4·FUNNEL wash `2b38e18`/`14e9e2c` into EG1/gR45 · ≠ EG3 wash `7be1a55`/`5b3c854` · Ban silent flip · Ban flip `gR45Closed`/r4/funnel/eg3/eg4/eg5/eg6/`ms3EqualsR4Closed` · Ban invent coveredCount · Ban forge · Ban假关 · Ban empty meta prove · Ban closing EG2 · Dual PASS ≠ coding · Dual PASS ≠ next knife auto-authorize · `eg1ProductClosed=false` · `gR45DualClaimClosed=false` · `gR45Closed=false` · r4/funnel/EG3/EG4/EG5/EG6 product flags **retained** · `ms3EqualsR4Closed=false` **retained** · coveredCount **not invented** · `releaseEvidence=false` · ≠HA · zero coding · zero prove · zero flip · Ban self-approve · Ban Cloud Agent · Ban Meridian · Ban secrets / `.env*` · Key×3 O3 honesty_red **非阻塞**
- Lifecycle: L0 this open · L1–L5 coding/flip/prove/SSOT **not** executed · post-prove → nail → STOP · no second knife
- Acceptance later: pre-exec dual BOTH PASS → standing authorize → if evidence sufficient honest flip `eg1ProductClosed` and/or `gR45DualClaimClosed` else honest non-flip → dedicated product-close prove EXIT **2×0** → authorized SSOT → post-prove dual BOTH PASS → lifecycle nail → STOP · **Ban** flip `gR45Closed` · **Ban** closing EG2 · **Ban** invent coveredCount
