...
| `RAG-FUNNEL-02B` | **not_covered** | durable embedding compute cache not evidenced on production consumer path · Ban invent covered |
...
| `RAG-FUNNEL-05` | **not_covered** | same-leaf LLM generation on clean miss not evidenced · Ban invent covered |
| `RAG-FUNNEL-06` | **not_covered** | route-scope cache/provenance/revoke not evidenced · Ban invent covered |
...
**coveredCount**: 3 (honest · Ban invent · Batch1 03/04 + Batch2 02A/02B when affirmed)
...
*Matrix · EG2+Batch1+Batch2 · 2026-09-23 (~09:27 PT) · Ban invent covered · releaseEvidence=false*
