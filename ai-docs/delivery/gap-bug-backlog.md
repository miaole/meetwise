...
| GAP-RAG-04 | P0 | **EG3 / 题域 isolation product face closed under authorize**（`domainIsolationClosed=true` · `eg3ProductClosed=true` · G-R4-5/EG3 product-close knife · `executed:awaiting_post_prove_dual` · Ban self-nail `post_prove_dual_pass`）。track-local REAL-WIRE + G-R2-5 retrieve-side CLOSED retained · prior EG3 evidence tip `62c0e2f` / dual `c18e28f` retained OPEN evidence。**≠ R4/FUNNEL product all closed** · **≠ gR45Closed** · **≠ invent coveredCount / FUNNEL-01…08 covered** · **≠ wrong_track=0 invent** · **MS3 ≠ R4 closed** · `releaseEvidence=false` · ≠HA | 题域 isolation product face closed under authorize；不得宣称 R4/FUNNEL/G-R4-5 all closed / invent coveredCount / MS3=R4 / wash prior tips | rag / product | post-prove dual BOTH PASS before lifecycle nail · Dual PASS ≠ next R4/FUNNEL auto-authorize · Ban wash EG3 `62c0e2f`/`c18e28f` · Ban wash R1 `9fec7c7`/`72233a0` into R4 all closed | `harness/g-r4-5-eg3-domain-isolation-product-close.md`；`harness/r4-domain-isolation.md`；`pnpm r4-eg3-domain-isolation-product-close:prove`；`pnpm r4-eg3-domain-isolation-product:prove`（retained evidence）；`pnpm mysql-stack:r4-domain-isolation:prove`；`m4-rag-hard-gates.md` §R4 |
