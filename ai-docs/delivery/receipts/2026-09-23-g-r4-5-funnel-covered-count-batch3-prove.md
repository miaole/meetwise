...
**FUNNEL-05 covered**: false
**FUNNEL-06 covered**: false
**FUNNEL-02A/02B/03/04 retained**: true/true/true/true
**coveredCount**: 4 (before=4 · after=4 · Ban invent)
**batch3CoveredCount**: 0
...
**05 refuse**: `production_path_not_wired_worker_or_interview_consumer` (honest · Ban invent)
**06 refuse**: `production_path_not_wired_retrieve_or_track_local_consumer` (honest · Ban invent)
