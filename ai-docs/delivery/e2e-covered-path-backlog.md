...
1. UC-018 covered-lift（UI + sole PG-retained CLOSED · FULL-E2E+GRAPH+TTL+waiting_user 已关；assessed · **canHonestlyFlip=false** · refuse：matrix §1.0 ADV still **blind** · 仍 **partial≠covered** · **#6 alone ≠ covered** · Ban假关 · `harness/uc-e2e-018-covered-lift.md` · `executed:awaiting_post_prove_dual` · `pnpm uc018:covered-lift:prove` · Ban invent covered · Ban wash SOLE alone into covered）
