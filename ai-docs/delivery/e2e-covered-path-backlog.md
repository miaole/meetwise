...
1. UC-018 covered-lift（UI + sole PG-retained CLOSED · FULL-E2E+GRAPH+TTL+waiting_user 已关；**canHonestlyFlip=false** · refuse：matrix §1.0 ADV was **blind** · tip **`abfbbc0`** · 仍 **partial≠covered** · **#6 alone ≠ covered** · Ban假关 · `harness/uc-e2e-018-covered-lift.md` · `post_prove_dual_pass` · `GAP-UC018-COVERED-LIFT` CLOSED as honest non-flip assessment only · **≠ UC covered** · prove tip `86953ca` · post-prove dual `0eb7ac4`/`5e70b55` · `pnpm uc018:covered-lift:prove` · Ban invent covered · Ban wash SOLE alone into covered）· **ADV coding+prove landed**（`harness/uc-e2e-018-adv.md` · `GAP-UC018-ADV` · **NHP-018-ADV-01** **partial** · `executed:awaiting_post_prove_dual` · §1.0 ADV **case-only→partial** · **ADV alone ≠ covered** · Ban wash ADV into covered · Ban flip §1.1 covered · **Ban skip to UC-011** · await post-prove dual · Ban self-nail）
2. UC-011 refund-callback 产品口 / balance-ui（HTTP H1–H5 已挂；H5=GAP+PREREQ ≠ 产品口；仍 ≠ covered · **Ban skip here while UC-018 ADV awaiting_post_prove_dual**）
