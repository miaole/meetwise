...
2. UC-011 refund-callback 产品口 / balance-ui（HTTP H1–H5 已挂；H5=GAP+PREREQ ≠ 产品口；仍 ≠ covered · **Ban skip here while UC-018 covered-lift-reassess OPEN / still partial≠covered** · ADV residual CLOSED · ADV alone ≠ covered · PERF/LOAD still blind）
