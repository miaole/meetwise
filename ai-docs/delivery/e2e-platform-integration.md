...
叠到 `origin/main` @ `517175c`（#65+#68+#69+#71+#70+#66+#73+#74+#75+#77+#82+#72+#79+#83）后的 always-on 尚未在本轮重跑。这不是 CI `verify`、不是 `--core`、不是 live E2E。隔离 Docker/remote proves 未跑、不进 always-on。本 PR 只 supersede #55–#64，不 supersede #83 / #79 / #72 / #82 / #77 / #75 / #74 / #73 / #66 / #70。作者不得自签 `review: passed`。不得 `--claim-done`。不得写「本轮局部验证完成」——审核仍是 `blocked:author_only`。
