...
| UC-E2E-050–052 | **partial**（**UC-052 deletion only**; 050/051 still honesty-pin） | **partial**（**UC-052 deletion only**; 050/051 still **gap**） | **partial**（**UC-052 deletion only**; 050/051 still **blind**） | **blind** | Aggregate row · **only UC-052 deletion** NEG/FAULT/BOUND elevated（prove `3c4847a` · EOR `08d54f8`/`3e39c1e` · receipts supporting≠EOR）· **UC-050 kill-switch** / **UC-051 no-PII** / export **not** elevated（pre-nail §1.0.1 was NEG partial/honesty-pin · FAULT **gap** · BOUND **blind**）· public DELETE **503** · **≠ covered** · coveredCount **8** |
