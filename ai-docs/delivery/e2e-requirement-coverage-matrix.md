...
| UC-E2E-018 | **partial** | **case-only**（NHP-018-FAULT-01） | **partial**（CAS waiting_user · **NHP-018-BOUND-01**） | **partial** | FULL-E2E+GRAPH+TTL+UI+SOLE(PG-retained) 已关；**#6 alone ≠ covered** · **≠ covered** · matrix stays **partial** · covered-lift assessed **canHonestlyFlip=false**（refuse ADV was **blind** · tip `abfbbc0` · retained）· **NHP-018-ADV-01** **partial**（`pnpm uc018:adv:prove` EXIT=0 · harness `harness/uc-e2e-018-adv.md` · tip `27dd6ae` · `post_prove_dual_pass` · `GAP-UC018-ADV` **CLOSED** · prove tip `bdc5993` · post-prove dual `5690779`/`9300d48`）· **ADV alone ≠ covered** · Ban wash ADV into covered · Ban flip §1.1 covered · Ban wash PERF/LOAD into covered · **covered-lift-reassess nailed** `harness/uc-e2e-018-covered-lift-reassess.md` · `GAP-UC018-COVERED-LIFT-REASSESS` CLOSED as honest non-flip assessment only · `post_prove_dual_pass` · prove tip `5cddb53` · post-prove dual `14a1859`/`7f57243` · **canHonestlyFlip=false**（**computed** at `5cddb53`）· refuse then：**PERF/LOAD blind** · `pnpm uc018:covered-lift-reassess:prove` · Ban invent covered · Ban假关 · Ban skip to UC-011  · **PERF/LOAD nailed** `harness/uc-e2e-018-perf-load.md` · `GAP-UC018-PERF-LOAD` **CLOSED** · **NHP-018-PERF-01** + **NHP-018-LOAD-01** **partial** · status `post_prove_dual_pass` · prove tip `b29c191` · Step A `8c7ee0c` · evidence of record = dual `1745bee`/`37c89dc`+`e33dd63` · implementer receipts **not evidence of record** · **workerCapEnforced=false** · `canHonestlyFlip@b29c191` = constant-false no-flip guard（**not** an assessment · Ban 「assessed, cannot flip」）· **PERF/LOAD partial ≠ UC covered** · §1.1 stays **partial** · Ban invent covered · Ban flip §1.1 covered · Ban claim production capacity / HA · Ban skip to UC-011 · covered-lift = separate later knife（must restore computable six-column evaluator） · **COVERED-CRITERION nailed** `harness/uc-e2e-018-covered-criterion.md` · `GAP-UC018-COVERED-CRITERION` **CLOSED** · status `post_prove_dual_pass` · runner `22790a8` · receipts `971bb80` · post-prove dual `fc7dc24`/`6d2841c` BOTH PASS · evaluator `scripts/lib/uc-covered-evaluator.mjs` + gatherer · last-line Verdict · mutation **423/423** · flip⇒empty-reasons · `b29c191` constant-false retired · reassess calls evaluator · real UC-018 `canHonestlyFlip=false` · UC-018/§1.1 stay **partial** · Ban invent covered · D1 **NHP-018-BOUND-01** **partial** · D2 FAULT **case-only** · follow-ups `GAP-UC018-RECEIPT-BACKFILL` · `GAP-EVAL-PARSER-DETAILS-UNCLOSED` · C-WORD-NEG |
...
| UC-E2E-050–052 | **partial**（**UC-052 deletion + checkpoint physical**; 050/051 still **partial**/honesty-pin） | **partial**（**UC-052 deletion + checkpoint physical**; 050/051 still **gap**） | **partial**（**UC-052 deletion + checkpoint physical**; 050/051 still **blind**） | **blind** | Aggregate · **UC-052 deletion**（prove `3c4847a` · EOR `08d54f8`/`3e39c1e`）+ **UC-052 checkpoint physical purge**（`GAP-PRIV-CHECKPOINT-FENCE-ONLY` · prove `69de818` · receipts `c549d20` · dual EOR `118e28f`/`2e743b2` · status `post_prove_dual_pass` · `pnpm uc052:checkpoint-physical:prove` · admin 三表 COUNT=0 · no-revive via **DB fence/trigger**（0047）· FOR UPDATE barrier = **extra stress only** · **NOTE-RACE-REFUSE-VIA-FENCE**）· 050/051 / export **not** elevated · public DELETE **503** · externals **`retention_pending`** · **≠ covered** · coveredCount **8** |
...
| UC-E2E-018（abandon） | **partial**（NHP-018-PERF-01 · `post_prove_dual_pass` · prove tip `b29c191` · dual evidence of record） | **n/a**(非 UI 主 · Ban n/a-dodge api/worker capacity) | **partial**（NHP-018-LOAD-01 · `workerCapEnforced=false` · release+safe-terminate inside capped API） | `GAP-UC018-PERF-LOAD` **CLOSED** · harness `harness/uc-e2e-018-perf-load.md` · `post_prove_dual_pass` · evidence of record = dual `1745bee`/`37c89dc`+`e33dd63` · implementer receipts not evidence of record · **PERF/LOAD partial ≠ UC covered** · §1.1 stays **partial** · local ≠ prod ≠ HA · p99@N=100 statistically weak · Ban wash into covered · Ban claim production capacity/HA · cite `testing/e2e-performance-evidence.md` · reassess/`0b7a218` · `canHonestlyFlip@b29c191` constant-false guard not assessment · covered-lift = separate later knife |
...
| UC-E2E-018 | 用户放弃面试 | **NON-UI** `pnpm uc018:abandon:prove` + `pnpm uc018:abandon:http:prove` + **`pnpm uc018:abandon:full-e2e:prove`** + **`pnpm uc018:graph:prove`** + **`pnpm uc018:ttl:prove`** + **`pnpm uc018:ui:prove`** + **`pnpm uc018:sole:prove`** + **`pnpm uc018:covered-lift:prove`** + **`pnpm uc018:adv:prove`** + **`pnpm uc018:covered-lift-reassess:prove`**（`GAP-UC018-FULL-E2E`+`GAP-UC018-GRAPH`+`GAP-UC018-TTL`+`GAP-UC018-UI`+`GAP-UC018-SOLE` **CLOSED** · sole=PG-retained · covered-lift **canHonestlyFlip=false** · refuse ADV was **blind** · tip `abfbbc0`；**ADV nailed** `harness/uc-e2e-018-adv.md` · tip `27dd6ae` · `GAP-UC018-ADV` **CLOSED** · **NHP-018-ADV-01** **partial** · `post_prove_dual_pass` · prove tip `bdc5993` · post-prove dual `5690779`/`9300d48` · **ADV alone ≠ covered** · Ban wash ADV into covered · Ban flip §1.1 covered · Ban skip to UC-011；**covered-lift-reassess nailed** `harness/uc-e2e-018-covered-lift-reassess.md` · `GAP-UC018-COVERED-LIFT-REASSESS` CLOSED as honest non-flip assessment only · `post_prove_dual_pass` · prove tip `5cddb53` · post-prove dual `14a1859`/`7f57243` · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind** · `pnpm uc018:covered-lift-reassess:prove` · Ban invent covered · Ban假关）；harness `harness/uc-e2e-018-user-abandon.md` §1b + `eval/uc-e2e-018-user-abandon.eval.md`；旁证 `commerce:prove` / `commerce-reconcile:prove`（旁证≠TTL钉）/ `neg:interview` | **partial** | db+HTTP+**full.e2e**+**graph**+**ttl**+**UI abandon**+**sole PG-retained**+covered-lift assessed+**ADV partial**；FULL-E2E+GRAPH+TTL+UI+SOLE 已关；§1.0 ADV **partial**；prior **canHonestlyFlip=false**（refuse ADV was **blind**）· reassess nailed · `post_prove_dual_pass` · CLOSED as honest non-flip · prove tip `5cddb53` · post-prove dual `14a1859`/`7f57243` · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind**（**ADV alone ≠ covered** · **NHP-018-PERF-01**+**NHP-018-LOAD-01** now **partial** · **PERF/LOAD partial ≠ UC covered** · Ban假关 · Ban flip §1.1）；**≠ covered** · **ADV alone ≠ covered**；**UI alone ≠ covered**；**#6 alone ≠ covered**；Ban假关；Ban wash SOLE/ADV alone into covered；Ban wash MySQL/Qdrant sole-wiring；fixture=pgvector retained production-aligned（`adr-postgres-retained.md`）；本绿≠全链路 E2E；eval≠covered；coveredCount **8** retained  · **PERF/LOAD nailed** `harness/uc-e2e-018-perf-load.md` · `GAP-UC018-PERF-LOAD` **CLOSED** · **NHP-018-PERF-01**+**NHP-018-LOAD-01** **partial** · `post_prove_dual_pass` · prove tip `b29c191` · dual `1745bee`/`37c89dc`+`e33dd63` · **PERF/LOAD partial ≠ covered** · Ban invent covered · Ban claim production capacity / HA · Ban skip to UC-011 · Ban cite canHonestlyFlip@b29c191 as assessed · **COVERED-CRITERION nailed** `harness/uc-e2e-018-covered-criterion.md` · `GAP-UC018-COVERED-CRITERION` **CLOSED** · status `post_prove_dual_pass` · runner `22790a8` · receipts `971bb80` · post-prove dual `fc7dc24`/`6d2841c` BOTH PASS · evaluator `scripts/lib/uc-covered-evaluator.mjs` + gatherer · last-line Verdict · mutation **423/423** · flip⇒empty-reasons · `b29c191` constant-false retired · reassess calls evaluator · real UC-018 `canHonestlyFlip=false` · UC-018/§1.1 stay **partial** · Ban invent covered · D1 **NHP-018-BOUND-01** **partial** · D2 FAULT **case-only** · follow-ups `GAP-UC018-RECEIPT-BACKFILL` · `GAP-EVAL-PARSER-DETAILS-UNCLOSED` · C-WORD-NEG · Ban writing covered |
...
| UC-E2E-050–052 | kill-switch / 无 PII / 删除导出 | `privacy-erasure:http:prove`（DELETE=503 pin）；**`pnpm uc052:internal-erasure:prove`**（deletion · tip `3c4847a`）；**`pnpm uc052:checkpoint-physical:prove`**（checkpoint physical · tip `69de818` · dual `118e28f`/`2e743b2` · receipts `c549d20`）；harness `harness/uc-e2e-050-052-privacy-erasure.md` + `harness/uc-e2e-052-checkpoint-physical.md` + `harness/privacy-erasure-http-503-pin.md` | **partial**（**UC-052 deletion + checkpoint physical**）/ **blocked**（export · open DELETE） | UC-052 deletion + **checkpoint physical purge** → **partial**（三表 admin=0 · no-revive=**DB fence/trigger** · FOR UPDATE=extra stress · **NOTE-RACE-REFUSE-VIA-FENCE**）· externals **`retention_pending`** · DELETE **仍必须 503** · Ban elevate UC-050/051/export · **≠ covered** · `GAP-PRIV-CHECKPOINT-FENCE-ONLY` **CLOSED** this nail · coveredCount **8** · cite known RED：`eval-harness-matrix-cite:prove` EXIT=1（UC-018 facet[2] · Line A · **非本刀**） |
...
| P0-8 | UC-E2E-018 用户放弃 | **集成+HTTP+full.e2e+graph+ttl+UI+sole PG-retained+covered-lift+ADV prove 已挂** `pnpm uc018:abandon:prove` + `pnpm uc018:abandon:http:prove` + `pnpm uc018:abandon:full-e2e:prove` + `pnpm uc018:graph:prove` + `pnpm uc018:ttl:prove` + `pnpm uc018:ui:prove` + `pnpm uc018:sole:prove` + `pnpm uc018:covered-lift:prove` + `pnpm uc018:adv:prove` + `pnpm uc018:covered-lift-reassess:prove` + harness §1b（FULL-E2E+GRAPH+TTL+UI+`GAP-UC018-SOLE` **CLOSED** under PG-retained；covered-lift **canHonestlyFlip=false** · refuse ADV was **blind** · tip `abfbbc0`；**ADV** tip `27dd6ae` · `GAP-UC018-ADV` **CLOSED** · **NHP-018-ADV-01** **partial** · `post_prove_dual_pass` · prove tip `bdc5993` · post-prove dual `5690779`/`9300d48` · **ADV alone ≠ covered**；**covered-lift-reassess nailed** · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind** · `pnpm uc018:covered-lift-reassess:prove`）；**UI alone ≠ covered**；**#6 alone ≠ covered**；Ban假关 | 矩阵 **partial**；§1.0 ADV **partial**；本绿≠全链路 E2E covered；≠covered；Ban wash SOLE/ADV alone into covered；Ban wash MySQL/Qdrant sole-wiring；coveredCount **8** retained  · **PERF/LOAD nailed** · NHP-018-PERF/LOAD **partial** · `post_prove_dual_pass` · GAP CLOSED · Ban invent covered · Ban skip to UC-011 · **COVERED-CRITERION nailed** `harness/uc-e2e-018-covered-criterion.md` · `GAP-UC018-COVERED-CRITERION` **CLOSED** · status `post_prove_dual_pass` · runner `22790a8` · receipts `971bb80` · post-prove dual `fc7dc24`/`6d2841c` BOTH PASS · evaluator `scripts/lib/uc-covered-evaluator.mjs` + gatherer · last-line Verdict · mutation **423/423** · flip⇒empty-reasons · `b29c191` constant-false retired · reassess calls evaluator · real UC-018 `canHonestlyFlip=false` · UC-018/§1.1 stay **partial** · Ban invent covered · D1 **NHP-018-BOUND-01** **partial** · D2 FAULT **case-only** · follow-ups `GAP-UC018-RECEIPT-BACKFILL` · `GAP-EVAL-PARSER-DETAILS-UNCLOSED` · C-WORD-NEG |
...
| eval harness cite | `pnpm eval-harness-matrix-cite:prove` | **1**（known RED） | UC-052 facets PASS；FAIL=`UC-018 facet[2]`（Line A · `GAP-EVAL-PARSER-DETAILS-UNCLOSED` bisect）· **≠** UC-052 nail green · ≠业务 covered |
...
| UC-E2E-018 abandon | `pnpm uc018:abandon:prove` + `pnpm uc018:abandon:http:prove` + `pnpm uc018:abandon:full-e2e:prove` + `pnpm uc018:graph:prove` + `pnpm uc018:ttl:prove` + `pnpm uc018:ui:prove` + `pnpm uc018:sole:prove` + `pnpm uc018:covered-lift:prove` + `pnpm uc018:adv:prove` + `pnpm uc018:covered-lift-reassess:prove` + `pnpm uc018:covered-criterion:prove` | **0**×10（db+HTTP+full-e2e+graph+ttl+UI+sole+covered-lift+ADV+reassess；R5） | db+HTTP+waiting_user+**FULL-E2E**+**GRAPH**+**TTL**+**UI**+**SOLE**+covered-lift assessed+**ADV partial**；**partial**；prior **canHonestlyFlip=false** · reassess nailed · `post_prove_dual_pass` · CLOSED as honest non-flip · prove tip `5cddb53` · post-prove dual `14a1859`/`7f57243` · **canHonestlyFlip=false** · refuse：**PERF/LOAD blind**（**ADV alone ≠ covered** · PERF/LOAD was blind at reassess `5cddb53` · now **NHP-018-PERF-01**+**NHP-018-LOAD-01** **partial** · `GAP-UC018-PERF-LOAD` **CLOSED** · `post_prove_dual_pass` · Ban假关）；**UI alone ≠ covered** · **ADV alone ≠ covered**；**#6 alone ≠ covered**；≠covered；Ban假关；R5  · **`pnpm uc018:perf-load:prove`** EXIT=0 · prove tip `b29c191` · evidence of record = dual · PERF/LOAD **partial ≠ covered** · Ban invent covered · **COVERED-CRITERION nailed** `harness/uc-e2e-018-covered-criterion.md` · `GAP-UC018-COVERED-CRITERION` **CLOSED** · status `post_prove_dual_pass` · runner `22790a8` · receipts `971bb80` · post-prove dual `fc7dc24`/`6d2841c` BOTH PASS · evaluator `scripts/lib/uc-covered-evaluator.mjs` + gatherer · last-line Verdict · mutation **423/423** · flip⇒empty-reasons · `b29c191` constant-false retired · reassess calls evaluator · real UC-018 `canHonestlyFlip=false` · UC-018/§1.1 stay **partial** · Ban invent covered · D1 **NHP-018-BOUND-01** **partial** · D2 FAULT **case-only** · follow-ups `GAP-UC018-RECEIPT-BACKFILL` · `GAP-EVAL-PARSER-DETAILS-UNCLOSED` · C-WORD-NEG |
