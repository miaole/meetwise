...
| UC-E2E-018（abandon） | **blind**→**case-only**（NHP-018-PERF-01） | **n/a**(非 UI 主 · Ban n/a-dodge api/worker capacity) | **blind**→**case-only**（NHP-018-LOAD-01） | REQUEST OPEN `harness/uc-e2e-018-perf-load.md` · Ban elevate to **partial** this open · local ≠ prod ≠ HA · Ban post-hoc retune · PERF/LOAD alone ≠ covered · cite `testing/e2e-performance-evidence.md` · reassess/`0b7a218` refuse |
